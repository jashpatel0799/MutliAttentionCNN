...
dataset_group.add_argument("--dataset_path", type=str, default="/home/planck/Bikash_J/CUB_200_2011",
                           help="dataset path")
...
class MACNN(nn.Module):
    def __init__(self):
        ...
        self.vgg.classifier[6] = nn.Linear(num_ftrs,200)
        # input_size = 224
        # self.vgg.fc = nn.Linear(2048, num_classes)
        self.feat_dims = 512
